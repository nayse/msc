...
if __name__ == "__main__":
    ...
    folders = [
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\OpenTracks\results\PRONTOS\ChatGPT\script_prompt",
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\OpenTracks\results\PRONTOS\Claude\script_prompt",
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\OpenTracks\results\PRONTOS\Gemini\script_prompt"
    r"C:\Users\nayse\Downloads\experiments\ARTIGO\OpenTracks\results\PRONTOS\gemma12b\script_promt"
]



    core_keywords = [
    "track list", "search", "track_list_search_view", "track_list_toolbar",
    "track_list_markers", "markers", "settings", "track_list_settings",
    "sensor start", "sensor_start_button", "aggregated stats", "aggregated_stats_button",
    "floating action button", "fab", "track_list_fab_action",
    "new track creation", "recording starts"
]
