...
if __name__ == "__main__":
    ...
    folders = [
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\OpenCamera\results\PRONTO\ChatGPT\script_prompt",
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\OpenCamera\results\PRONTO\Claude\script_prompt",
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\OpenCamera\results\PRONTO\Gemini\script_prompt"
    r"C:\Users\nayse\Downloads\experiments\ARTIGO\OpenCamera\results\PRONTO\gemma12b\script_promt"
]

    core_keywords = [
    "press take photo button",
    "tap exposure lock",
    "confirm exposure locked",
    "tap record button",
    "stop video recording",
    "open gallery",
    "view captured media",
    "drag zoom seekbar",
    "observe zoom preview",
    "tap settings icon",
]
