...
if __name__ == "__main__":
    ...
    folders = [
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\Bitwarden\results\PRONTO\ChatGPT\script_promt",
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\Bitwarden\results\PRONTO\Claude\script_promt",
    #r"C:\Users\nayse\Downloads\experiments\ARTIGO\Bitwarden\results\PRONTO\Gemini\script_promt",
    r"C:\Users\nayse\Downloads\experiments\ARTIGO\Bitwarden\results\PRONTO\gemma12b\script_promt"
]

    core_keywords = [
    "tap continue without email",
    "enter valid email",
    "enter email and continue",
    "reopen app with remembered email",
    "toggle remember email off",
    "reopen app without remembered email",
